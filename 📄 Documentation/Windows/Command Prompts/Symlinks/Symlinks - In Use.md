...
```bash
mklink /D "X:\my-projects\digital-universe\pistolwhip-justin" "X:\my-projects\pistolwhip-justin"
```

```bash
mklink /D "X:\my-projects\digital-universe\gh-projects-on-google-calendar" "X:\my-projects\gh-projects-on-google-calendar"
```
